...
${FASTALIGN_DIR}/build/fast_align -i ${source_name}_${target_name} -p ${direction}.model -d -o -v > ${direction}.talp 2> ${direction}.error
${FASTALIGN_DIR}/build/fast_align -i ${target_name}_${source_name} -p ${direction}.reverse.model -d -o -v > ${direction}.reverse.talp 2> ${direction}.reverse.error
